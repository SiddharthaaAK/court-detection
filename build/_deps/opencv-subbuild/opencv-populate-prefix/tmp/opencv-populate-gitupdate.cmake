...
execute_process(
  COMMAND "/usr/bin/git" show-ref 3.4.12
  WORKING_DIRECTORY "/home/aitest/sesha/mono-track-sesha/monotrack/court-detection/build/_deps/opencv-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.4.12")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.4.12")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 3.4.12
  WORKING_DIRECTORY "/home/aitest/sesha/mono-track-sesha/monotrack/court-detection/build/_deps/opencv-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/opencv/opencv.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/aitest/sesha/mono-track-sesha/monotrack/court-detection/build/_deps/opencv-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/aitest/sesha/mono-track-sesha/monotrack/court-detection/build/_deps/opencv-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
