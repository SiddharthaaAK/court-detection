...
int main(int argc, char** argv)
{
  ...
  // Check if ffmpeg is mentioned in the build information
  if (buildInfo.find("FFmpeg:") != std::string::npos) {
    std::cout << "OpenCV is built with ffmpeg support\n";
  } else {
    std::cout << "OpenCV might not be built with ffmpeg support\n";
  }
